...
import { getXiaoliurenThemeImageUrl } from './divinationTheme';
...
const xiaoliurenImageFiles: Record<XiaoliurenPalaceName, string> = {
  大安: 'da-an.webp',
  留连: 'liu-lian.webp',
  速喜: 'su-xi.webp',
  赤口: 'chi-kou.webp',
...
export function getXiaoliurenPresentationImage(name: XiaoliurenPalaceName) {
  return getXiaoliurenThemeImageUrl(xiaoliurenImageFiles[name]);
}
