...
const offeringOptions: OfferingOption[] = [
  ...
  { key: 'grape', label: '葡萄', image: '/divination-assets/temple/offerings/grapes.png' },
  { key: 'zongzi', label: '粽子', image: '/divination-assets/temple/offerings/zongzi.png' },
  { key: 'fish', label: '鲜鱼', image: '/divination-assets/temple/offerings/fish.png' },
  { key: 'chicken', label: '全鸡', image: '/divination-assets/temple/offerings/chicken.png' },
  ...
  { key: 'rice-cake', label: '粿品', image: '/divination-assets/temple/offerings/rice-cake.png' },
