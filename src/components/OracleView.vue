...
type OraclePhase = 'idle' | 'drawn' | 'confirming' | 'confirmed' | 'rejected';
...
<template>
  <UiPageShell width="reading" class="screen oracle-screen" :class="{ 'is-result': Boolean(displayResult) }">
    ...
    <UiWorkspaceSurface v-else-if="phase === 'drawn' || phase === 'confirming' || phase === 'rejected'" class="oracle-workspace oracle-ritual" padding="standard" aria-live="polite">
